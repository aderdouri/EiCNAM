...
inline vector<double> calculateAdjoints(ToyNumber &result)
{
    //  initialization
    ...
    RNG &random)
{
    ...
    for (int i = 0; i < Np; ++i)
    {
        ...
        //  Payoff
        /* if (alive && spot > strike) result += spot - strike; */ if (spot > strike)
